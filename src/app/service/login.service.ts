...
export class LoginService {
  ...
  register(user): Observable<any> {
    return this.http.post("http://9ece3500.ngrok.io/login/signup", user, this.httpOptions);
  }

  login(credentials): Observable<any> {
    this.isLoggedIn = true;
    return this.http.post("http://9ece3500.ngrok.io/login/signin",credentials, this.httpOptions);
  }
