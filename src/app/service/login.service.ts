...
export class LoginService {
  ...
  url = "http://726659f0.ngrok.io/login";
  ...
  register(user): Observable<any> {
    return this.http.post("http://726659f0.ngrok.io/login/signup", user, this.httpOptions);
  }

  login(credentials): Observable<any> {
    this.isLoggedIn = true;
    return this.http.post("http://726659f0.ngrok.io/login/signin",credentials, this.httpOptions);
  }
